...
<qgis simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyMaxScale="1" version="3.16.11-Hannover" maxScale="0" simplifyDrawingTol="1" readOnly="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyLocal="1" minScale="100000000">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <temporal startExpression="" fixedDuration="0" mode="0" endExpression="" accumulate="0" endField="" durationUnit="min" enabled="0" startField="" durationField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <renderer-v2 enableorderby="0" symbollevels="0" attr="Vrsta " forceraster="0" type="categorizedSymbol">
    <categories>
      <category label="Bojena keramika" value="Bojena keramika" render="true" symbol="0"/>
      <category label="Bronzanodobska i neolitska keramika" value="Bronzanodobska i neolitska keramika" render="true" symbol="1"/>
      <category label="Bronzanodobska keramika" value="Bronzanodobska keramika" render="true" symbol="2"/>
      <category label="Deo ljudskog skeleta" value="Deo ljudskog skeleta" render="true" symbol="3"/>
      <category label="Deo podnice" value="Deo podnice" render="true" symbol="4"/>
      <category label="Gvozdenodobska keramika" value="Gvozdenodobska keramika" render="true" symbol="5"/>
      <category label="Kamen" value="Kamen" render="true" symbol="6"/>
      <category label="Kamena alatka udarač" value="Kamena alatka udarač" render="true" symbol="7"/>
      <category label="Keramika" value="Keramika" render="true" symbol="8"/>
      <category label="Keramika i kost" value="Keramika i kost" render="true" symbol="9"/>
      <category label="Keramika i lep" value="Keramika i lep" render="true" symbol="10"/>
      <category label="Keramika na vitlu" value="Keramika na vitlu" render="true" symbol="11"/>
      <category label="Keramika sa ukrasom" value="Keramika sa ukrasom" render="true" symbol="12"/>
      <category label="Kost" value="Kost" render="true" symbol="13"/>
      <category label="Kremen" value="Kremen" render="true" symbol="14"/>
      <category label="Lep" value="Lep" render="true" symbol="15"/>
      <category label="Ljudske kosti" value="Ljudske kosti" render="true" symbol="16"/>
      <category label="Neolitska keramika" value="Neolitska keramika" render="true" symbol="17"/>
      <category label="Noga zrtvenika" value="Noga zrtvenika" render="true" symbol="18"/>
      <category label="Skoljka" value="Skoljka" render="true" symbol="19"/>
      <category label="Veca koncentracija keramike i lepa" value="Veca koncentracija keramike i lepa" render="true" symbol="20"/>
      <category label="Zivotinjski zub" value="Zivotinjski zub" render="true" symbol="21"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" force_rhr="0" name="9">
        <layer class="SimpleMarker" enabled="1" pass="0" locked="0">
          <prop v="0" k="angle"/>
          <prop v="100,253,106,255" k="color"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="circle" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory sizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" spacingUnitScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" spacingUnit="MM" lineSizeType="MM" scaleBasedVisibility="0" spacing="5" sizeType="MM" penAlpha="255" enabled="0" minimumSize="0" penColor="#000000" direction="0" rotationOffset="270" maxScaleDenominator="1e+08" opacity="1" penWidth="0" height="15" minScaleDenominator="0" backgroundAlpha="255" width="15" backgroundColor="#ffffff" labelPlacementMethod="XHeight" diagramOrientation="Up" showAxis="1" barWidth="5">
  ...
  <DiagramLayerSettings obstacle="0" zIndex="0" priority="0" placement="0" linePlacementFlags="18" dist="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="Photo">
      <editWidget type="ExternalResource">
        <config>
          <Option type="Map">
            <Option type="QString" value="D:/MIlena/master gis/Semestar 1/Upravljanje GIS projektima/zadatak/zadatak 2/tacke za zadatak 2/Prikupljene tacke/Sve fotografije" name="DefaultRoot"/>
            ...
            <Option type="int" value="2" name="RelativeStorage"/>
            <Option type="int" value="0" name="StorageMode"/>
          </Option>
        </config>
      </editWidget>
    </field>
    <field configurationFlags="None" name="file path">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
  ...
  <aliases>
    ...
    <alias index="1" field="Vrsta " name=""/>
    <alias index="2" field="Photo" name=""/>
    <alias index="3" field="file path" name=""/>
    <alias index="4" field="layer" name=""/>
    <alias index="5" field="path" name=""/>
    <alias index="6" field="X" name=""/>
    <alias index="7" field="Y" name=""/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="file path"/>
  ...
  <constraints>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="Date" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="Vrsta " notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="Photo" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="file path" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="layer" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="path" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="X" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" exp_strength="0" field="Y" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="Date"/>
    <constraint desc="" exp="" field="Vrsta "/>
    <constraint desc="" exp="" field="Photo"/>
    <constraint desc="" exp="" field="file path"/>
  ...
  <attributetableconfig sortExpression="&quot;Vrsta &quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column hidden="0" type="field" name="Date" width="-1"/>
      <column hidden="0" type="field" name="Photo" width="-1"/>
      <column hidden="0" type="field" name="file path" width="-1"/>
      <column hidden="0" type="field" name="layer" width="-1"/>
      <column hidden="0" type="field" name="path" width="-1"/>
      <column hidden="0" type="field" name="X" width="-1"/>
      <column hidden="0" type="field" name="Y" width="101"/>
      <column hidden="1" type="actions" width="-1"/>
      <column hidden="0" type="field" name="Vrsta " width="395"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="file path"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="file path"/>
